...
//  SocialMovie
//
//  Created by Andrea Spinazzola on 19/03/18.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let startIntroVC = storyboard.instantiateViewController(withIdentifier: "intro")
        
        //ImagePipeline.Configuration.isAnimatedImageDataEnabled = true
        
        IQKeyboardManager.shared.enable = true
        
        SwiftyGiphyAPI.shared.apiKey = "Hf7fsvCmUCag0Mpp6ip3cLo5rF3Y4jKU"
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SocialMovie")
