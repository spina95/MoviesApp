...
public class SwiftyGiphyViewController: UIViewController {
    ...
    public override func loadView() {
        ...
        searchController.searchBar.barTintColor = UIColor(red: 23/255, green: 23/255, blue: 23/255, alpha: 1)
    ...
    public override func viewDidLoad() {
        ...
        //NotificationCenter.default.addObserver(self, selector: #selector(updateBottomLayoutConstraintWithNotification(notification:)), name: .UIResponder.ke, object: nil)
