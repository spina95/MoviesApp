...
public func getGenresList() -> [String] {
    return ["Action", "Adventure","Animation","Comedy", "Crime","Documentary","Drama","Family", "Fantasy", "Foreign", "History", "Horror", "Music", "Mystery", "Romance", "ScienceFiction", "TvMovie", "Thriller", "War", "Western"]
}

public func getYearsList() -> [Int] {
    var years = [Int]()
    for i in 1900...2019{
        years.append(i)
    }
...
public func genreToId(genre: String) -> MovieGenres {
    switch genre {
    case "Action":
