...
open class DiscoverMDB: ArrayObject {
	...
	public class func discover(discoverType: DiscoverType, params: [DiscoverParam], completionHandler: @escaping (ClientReturn, _ movieData: [MovieMDB]?, _ tvData: [TVMDB]?) -> ()) -> (){
		Client.discover(baseURL: discoverType.rawValue, params: params, completion: {
			data in
	...
	public class func discoverByRating(discoverType: DiscoverType, certification: String, certification_country: String, ceritfication_lte: String? = nil, ceritfication_gte: String? = nil,  sort_by: String? = nil, page: Int?,  language: String?,  completionHandler: @escaping (ClientReturn) -> ()) -> (){
