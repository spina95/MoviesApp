...
open class CircularSlider: UIControl {
    ...
    /**
     * The color shown for the selected portion of the slider disk. (between   and end values)
    ...
    override open func draw(_ rect: CGRect) {
        ...
        if endPointValue == -1 {
            endAngle = CircularSliderHelper.circleMinValue + CircularSliderHelper.circleInitialAngle
        }
